class Main extends Phaser.Scene {
    ...
    create() {
        ...
        this.plane = this.physics.add.sprite(25, 0, 'plane')
        //Масштабуємо літак
    ...
    addRowOfPipes() {
        ...
        for (var i = 0; i < 16; i++) {
            if (!(i >= hole && i <= hole + 6))
                this.addOnePipe(400, i * 30 + 10, this.velocity);
        }
        if (this.timedEvent.delay > 800) {
            this.timedEvent.delay -= 35;
            this.velocity += 5;
            this.anims.frameRate += 0.3;
        }
    }
